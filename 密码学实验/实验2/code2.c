...
*           original values
*           includes S-box convert¡ê, row convert, column convert
*			encryption
*-------------------------------------------------------------------------------
* EXAMPLE:
*-------------------------------------------------------------------------------
...
* RETURN:   None
*-------------------------------------------------------------------------------
* PURPOSE:  includes inverse S-box convert¡ê?inverse row convert, and inverse
*           column convert
*           encryption
*-------------------------------------------------------------------------------
* EXAMPLE:
...
* NAME:         main.c
* AES(Advanced 	Encryption Standard)Encryption Algorithm
* NOTES:        Running Mode¡ê: CBC (Ciphertext Block Chaining)
*		plaintext¡ê: 128000 bits
*		ciphertext¡ê: 128000 bits
* File:		plaintext.txt
*		ciphertext.txt
*		decry.txt
*******************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	for (j = 0; j <= 15; j++)				//array random initialization
		C[0][j] = rand() % 256;
	for (i = 0; i<1000; i++)				//loop 1000 times¡ê?generate 128 bits plaintext each time¡ê?encrypt in CBC mode
	{
		for (j = 0; j <= 15; j++)
		{
			M[i][j] = rand() % 256;
	...
	for (i = 0; i<1000; i++)				//loop 1000 times¡ê?read ciphertext in array C[][]¡ê?decrypt in CBC mode
	{
